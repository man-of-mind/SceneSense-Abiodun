...
> and design-freeze sequence is `UE_AGENT_EXECUTION_CHECKLIST_V2.md`. The former
...
> `UE_AGENT_EXECUTION_CHECKLIST_V2.md` plus the UE-only `state_diagram.md`.
