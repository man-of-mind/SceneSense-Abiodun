...
That difference is causally attributable to the two estimator settings within this fixed surrogate because replay, channel seeds, and per-tick latency shocks are paired. The residual at lag=0/noise=0 is not labelled irreducible: speed uncertainty, observation mismatch, worst-object aggregation, and map-state trajectory remain mixed in this three-episode vehicle-only corpus.
...
Run directory: `rl_agent/policy/experiments/estimator_sensitivity_smoke/20260810_205849`
