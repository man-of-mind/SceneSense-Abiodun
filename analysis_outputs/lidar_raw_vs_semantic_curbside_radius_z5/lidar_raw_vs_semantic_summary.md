...
## Runs
- `lidar_diagnostic_runs/curbside_raw_vs_semantic_lidar_clean_crossing_radius_z5`
...
|---|---|---|---:|---:|---:|---:|
| curbside_lidar_clean_crossing_radius_z5 | raw_bbox | vehicle | 0.000 | nan | 10.0 | 250 |
| curbside_lidar_clean_crossing_radius_z5 | raw_bbox | person | 0.848 | 0.197 | 10.7 | 250 |
| curbside_lidar_clean_crossing_radius_z5 | semantic_tag_bbox | vehicle | 0.000 | nan | 10.0 | 250 |
| curbside_lidar_clean_crossing_radius_z5 | semantic_tag_bbox | person | 0.840 | 0.286 | 11.2 | 250 |
| curbside_lidar_clean_crossing_radius_z5 | semantic_object_id | vehicle | 1.000 | 1.941 | 86.0 | 250 |
| curbside_lidar_clean_crossing_radius_z5 | semantic_object_id | person | 0.840 | 0.286 | 11.2 | 250 |

## Frame-Level Sensor Load

| Run | Frames | Raw pts/frame | Semantic pts/frame | Raw bytes/frame est. | Semantic bytes/frame est. |
|---|---:|---:|---:|---:|---:|
| curbside_lidar_clean_crossing_radius_z5 | 250 | 30391.1 | 55568.3 | 486257 | 1111366 |
