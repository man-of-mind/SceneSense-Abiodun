...
|---|---|---|---:|---:|---:|---:|
| curbside_lidar_clean_crossing | raw_bbox | vehicle | 0.000 | nan | 10.0 | 250 |
| curbside_lidar_clean_crossing | raw_bbox | person | 0.000 | nan | 0.0 | 250 |
| curbside_lidar_clean_crossing | semantic_tag_bbox | vehicle | 0.000 | nan | 10.0 | 250 |
| curbside_lidar_clean_crossing | semantic_tag_bbox | person | 0.000 | nan | 0.0 | 250 |
| curbside_lidar_clean_crossing | semantic_object_id | vehicle | 1.000 | 1.941 | 86.0 | 250 |
| curbside_lidar_clean_crossing | semantic_object_id | person | 0.840 | 0.286 | 11.2 | 250 |

## Frame-Level Sensor Load

| Run | Frames | Raw pts/frame | Semantic pts/frame | Raw bytes/frame est. | Semantic bytes/frame est. |
|---|---:|---:|---:|---:|---:|
| curbside_lidar_clean_crossing | 250 | 30391.1 | 55568.3 | 486257 | 1111366 |
