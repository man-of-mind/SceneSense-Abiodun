...
class World(object):
    def __init__(self, carla_world, hud, traffic_manager, args):
        ...
        logging.info(
            ...
            'follow the ego vehicle, strict static_blocker_v5/reactive_blocker_v5 '
            'vehicles, strict %s pedestrians, and configured traffic-light '
            ...
            'No map-node CARLA actor is spawned, discovered, or streamed.',
...
def game_loop(args):
    ...
    try:
        ...
        pygame.display.set_caption('CARLA Manual Control AR v12')
        display.fill((0,0,0))
        pygame.display.flip()
