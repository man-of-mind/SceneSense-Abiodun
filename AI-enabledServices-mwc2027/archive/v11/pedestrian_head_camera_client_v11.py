...
-------
    ...
    python3 pedestrian_head_camera_client_v11.py --record-route recorded_route.json

    # Re-run from the recorded start and press U to show its waypoint arrows.
    python3 pedestrian_head_camera_client_v11.py \\
...
def main() -> None:
    ...
    try:
        ...
        pygame.display.set_caption("CARLA Pedestrian Head Camera v11")
