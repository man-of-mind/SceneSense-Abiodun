...
captured vehicle blockers, an additional static Nissan Patrol blocker, and two
captured pedestrian blockers in Town10HD. Vehicle #3 is a
...
lane-following drive-through. Vehicles #1, #2, and #4 remain static. Repeating
...
Examples:
    # Spawn the four baked-in vehicles and two pedestrians.
    python3 spawn_blocker_v5.py

    # Replace only the pedestrian defaults; keep the four default vehicles.
    python3 spawn_blocker_v5.py \\
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "default static blocker #4 remains "
            "vehicle.nissan.patrol (default for all other targets: %(default)s)"
        ),
    )
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    try:
        ...
        LOG.info(
            "Passive client: a manual client/server must advance ticks; "
